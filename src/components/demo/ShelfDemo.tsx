...
export function ShelfDemo() {
  ...
  return (
    <DemoStage
      variant="wide"
      className="bg-[linear-gradient(145deg,#243044_0%,#1a2332_40%,#121a27_100%)]"
    >
      <div
        aria-hidden
      ...
      {/* Desktop icons — left */}
      <div className="absolute top-8 left-7 z-10 flex flex-col gap-6 sm:left-10">
        <motion.div
      ...
      {/* Mail compose — realistic Outlook-style window */}
      <AnimatePresence>
        {mailVisible ? (
          <motion.div
            key="mail"
            className={cn(
              'absolute top-6 bottom-[64px] left-4 z-20 flex w-[min(460px,calc(100%-430px))] min-w-[280px] flex-col overflow-hidden rounded-[12px] bg-[#202020] shadow-[0_24px_64px_rgba(0,0,0,0.45)] ring-1 ring-white/12 sm:left-8 sm:w-[min(520px,calc(100%-440px))]',
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-hidden px-4 py-3 text-[12px] leading-relaxed text-white/70">
              <p>Hi team,</p>
              <p className="mt-3">Sharing the latest project brief — please review when you get a chance.</p>
      ...
      {/* Stash panel — anchored bottom-right above the tray */}
      <div className="absolute top-5 right-3 bottom-[56px] z-30 w-[min(400px,calc(100%-1.25rem))] sm:right-4 sm:w-[400px]">
        <motion.div
